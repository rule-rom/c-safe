...
| [Защита указателей](pointer_guards.md) | Защита арифметики указателей | 🚧 Draft |
| [Валидация типов (TYPE-INTENT)](type_validation.md) | Безопасное приведение типов | 🚧 Draft |
| [Lifecycle Tracking (Пастух)](lifecycle_tracking.md) | Отслеживание рождения/смерти переменных | 🚧 Draft |
